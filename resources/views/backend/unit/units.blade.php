  ...
  <script>
    ...
    <div class="mb-9">
      <div class="row g-3 mb-4">
        <div class="col-auto">
          <h2 class="mb-2"></h2>
          <h5 class="text-body-tertiary fw-semibold">List of Units</h5>
        </div>
        <div class="col-auto">
          <h2 class="mb-0"></h2>
        ...
        <div class="mb-4">
          <div class="d-flex flex-wrap gap-3">
            ...
            <div class="ms-xxl-auto">
              ...
              <a href="{{ route('add.unit') }}"> <button class="btn btn-primary" id="addBtn"><span class="fas fa-plus me-2"></span>Add Unit</button></a> 
            </div>
          </div>
        </div>
            ...
            <table class="table fs-9 mb-0">
              ...
              <thead>
                <tr>
                  ...
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Unit Type</th>
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Base Unit Name</th>
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Symbol</th>
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Unit Converstion</th>
                    ...
                    <td class="align-middle white-space-nowrap  ps-4 btn-reveal-trigger">
                      <div class="btn-reveal-trigger position-static">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-2">
                          ...
                          <a class="dropdown-item" href="{{ route('edit.unit', $unit->id) }}">Edit</a>
                          <a class="dropdown-item text-danger" href="{{ route('remove.unit', $unit->id) }}">Remove</a>
                        </div>
                      </div>
                    </td>
              </tr>
