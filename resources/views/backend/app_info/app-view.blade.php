    ...
    <div class="mb-9">
      <div class="row g-3 mb-4">
        <div class="col-auto">
          ...
          <h5 class="text-body-tertiary fw-semibold">View</h5>
          ...
          <div class="d-flex flex-wrap gap-3">
            <div class="search-box">
              <form class="position-relative">
                <input class="form-control search-input search" type="search" placeholder="Search apps info" aria-label="Search" />
            ...
            <div class="ms-xxl-auto">
              <button class="btn btn-link text-body me-4 px-0"><span class="fa-solid fa-file-export fs-9 me-2"></span>Export</button>
                 <a href="{{ route('app.info') }}"><button class="btn btn-primary" id="addBtn"><span class="fas fa-plus me-2"></span>App Info</button></a> 
            </div>
            ...
            <table class="table fs-9 mb-0">
              ...
              <thead>
                <tr>
                  ...
                  <th class="sort align-middle ps-4" scope="col" data-sort="title" style="width:50px;">System Title</th>
                  <th class="sort align-middle ps-4" scope="col" data-sort="email" style="width:50px;">Email</th>
                  <th class="sort align-middle ps-4" scope="col" data-sort="phone" style="width:50px;">Phone</th>
                  <th class="sort align-middle ps-4" scope="col" data-sort="description" style="width:50px;">System Description</th>
                  <th class="sort align-middle ps-4" scope="col" data-sort="date" style="width:50px;">Date</th>

                  <th class="sort align-middle ps-4" scope="col" data-sort="" style="width:50px;">Actions</th>
                </tr>
              </thead>
            ...
            @foreach ($records as $record)
                <tr class="position-static">
                    ...
                    <td class="align-middle white-space-nowrap py-0"><a class="d-block border border-translucent rounded-2" href="../../../apps/e-commerce/landing/product-details.html">
                      ...
                      @if($record->logo_img_id)
                     
                      <img src="{{$record->logoImage->absolute_path}}" alt="" width="53" />
                    ...
                    {{-- <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger"> --}}
                      ...
                      <div class="btn-reveal-trigger position-static">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-2">
                          <a class="dropdown-item text-danger" href="{{route('remove.app', $record->id)}}">Remove</a>
                        </div>
                      </div>
                    </td>
              </tr>
