...
<div class="content">
    ...
    <form action="{{ route('post.edit.user', $user_id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row g-3 flex-between-end mb-5">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-sm-6">
                ...
                <input class="form-control" id="first name" type="text" placeholder="First Name" name="first_name" value="{{ old('first-name') }}" />
            </div>

            <div class="col-sm-6">
                <label class="form-label" for="last-name">Last Name</label>
                <input class="form-control" id="last name" type="text" placeholder="Last Name" name="last_name" value="{{ old('last-name') }}" />
            </div>
         ...
         <div class="col-sm-6">
           ...
           <input class="form-control form-icon-input" id="password_confirmation " type="password" placeholder="Confirm Password"  name="password_confirmation"/>
            ...
            <div class="col-sm-6">
                ...
                <input class="form-control" id="city" type="text" placeholder="City" name="city" value="{{ old('city') }}" />
            </div>
            <div class="col-sm-6">
                <label class="form-label" for="zip_code">Zip Code</label>
                <input class="form-control" id="zip_code" type="text" placeholder="Zip Code" name="zip_code" value="{{ old('zip_code') }}" />
            </div>

            <div class="col-sm-6">
                <label class="form-label" for="state">State</label>
                <input class="form-control" id="state" type="text" placeholder="State" name="state" value="{{ old('state') }}" />
            </div>
