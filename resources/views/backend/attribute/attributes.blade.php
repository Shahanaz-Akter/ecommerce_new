 ...
 alerts.forEach((alert)=>{
    ...
    <div class="mb-9">
      <div class="row g-3 mb-4">
        <div class="col-auto">
          <h2 class="mb-2"></h2>
          <h5 class="text-body-tertiary fw-semibold">List of Attributes</h5>
        </div>
        <div class="col-auto">
          <h2 class="mb-0"></h2>
        ...
        <div class="mb-4">
          <div class="d-flex flex-wrap gap-3">
            ...
            <div class="ms-xxl-auto">
              ...
              <a href="{{ route('add.attribute') }}"> <button class="btn btn-primary" id="addBtn"><span class="fas fa-plus me-2"></span>Add Attribute</button></a> 
            </div>
          </div>
        </div>
            ...
            <table class="table fs-9 mb-0">
              ...
              <thead>
                <tr>
                  ...
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Slug</th>
                    ...
                    <td class="align-middle white-space-nowrap  ps-4 btn-reveal-trigger">
                      <div class="btn-reveal-trigger position-static">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-2">
                          ...
                          <a class="dropdown-item" href="{{ route('edit.attribute', $attribute->id)}}">Edit</a>
                          <a class="dropdown-item text-danger" href="{{ route('remove.attribute', $attribute->id) }}">Remove</a>
                        </div>
                      </div>
                    </td>
              </tr>
