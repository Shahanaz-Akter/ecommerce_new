...
<div class="content">
    ...
    <div class="mb-9">
      <div class="row g-3 mb-4">
        <div class="col-auto">
          <h2 class="mb-2"></h2>
          <h5 class="text-body-tertiary fw-semibold">List of Colors</h5>
        </div>
        <div class="col-auto">
          <h2 class="mb-0"></h2>
        ...
        <div class="mb-4">
          <div class="d-flex flex-wrap gap-3">
            ...
            <div class="ms-xxl-auto">
              ...
              <a href="{{ route('add.color') }}"> <button class="btn btn-primary" id="addBtn"><span class="fas fa-plus me-2"></span>Add Color</button></a> 
            </div>
          </div>
        </div>
            ...
            <table class="table fs-9 mb-0">
              ...
              <thead>
                <tr>
                  ...
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Name</th>
                  <th class="sort white-space-nowrap align-middle ps-4" scope="col" style="width:350px;" data-sort="product">Color Code</th>
