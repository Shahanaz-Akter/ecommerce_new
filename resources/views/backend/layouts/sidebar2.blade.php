          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item-wrapper">
                    <a class="nav-link dropdown-indicator label-1" href="#nv-e-commerce" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-e-commerce">
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon"></div><span class="nav-link-icon"><span data-feather="shopping-cart"></span></span><span class="nav-link-text">E commerce</span> 
                    </div>
                  </a>
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-e-commerce">
                      ...
                      {{-- user start --}}
                      <li class="nav-item">
                        <a class="nav-link dropdown-indicator" href="#nv-user" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-user">
                          <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-text">User</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                        <div class="parent-wrapper">
                            
                          <ul class="nav collapse parent show" data-bs-parent="#e-ecommerce" id="nv-user">

                            <li class="nav-item"><a class="nav-link active" href="{{ route('users') }}">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="{{ route('add.user') }}">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('add.role') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Add Role</span>
                                </div>
                              </a>
                              <!-- more inner pages-->
                            </li>
                    ...
                    {{-- Product start --}}
                      ...
                      <li class="nav-item">
                        <a class="nav-link dropdown-indicator" href="#nv-product" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-product">
                          <div class="d-flex align-items-center">
                            <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-text">Product</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                        <div class="parent-wrapper">
...
<a class="nav-link dropdown-indicator label-1" href="#nv-users" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-users">
    ...
    <div class="d-flex align-items-center">
    <div class="dropdown-indicator-icon"></div><span class="nav-link-icon"><span data-feather="user"></span></span><span class="nav-link-text">User</span> <span class="ms-2 fas fa-caret-right"></span>
    </div>
</a>
...
<div class="parent-wrapper label-1">
    ...
    <li class="nav-item"><a class="nav-link" href="{{ route('add.user') }}">
...
<div class="d-flex align-items-center">
<div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-icon"><span data-feather="square"></span></span><span class="nav-link-text">Product</span>
</div>
</a>
    ...
    <div class="parent-wrapper label-1">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('products') }}">
            <div class="d-flex align-items-center"><span class="nav-link-text">
                <i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>Products</span>
            </div>
            </a>
            <!-- more inner pages-->
        </li>
        <li class="nav-item"><a class="nav-link" href="{{ route('add.product') }}">
            <div class="d-flex align-items-center"><span class="nav-link-text"><i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>Add Product</span>
            </div>
        </a>
        <!-- more inner pages-->
        </li>
        <li class="nav-item"><a class="nav-link" href="{{ route('variant.list') }}">
            <div class="d-flex align-items-center"><span class="nav-link-text">   <i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>Variant List</span>
            </div>
        </a>
        <!-- more inner pages-->
        </li>
                 ...
                 <div class="nav-item-wrapper">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="dropdown-indicator-icon"><span class="fas fa-caret-right"></span></div><span class="nav-link-icon"><span data-feather="square"></span></span><span class="nav-link-text">Report</span>
                    </div>
                  </a>
                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-report">
                      ...
                      <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">
                            <i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>User Report</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text"><i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>Product Report</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text">   <i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>Customer  Report</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text">   <i class="fa-solid fa-circle me-1 mb-1 bullet-items"></i>Stock Report</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                ...
                <div class="nav-item-wrapper">
                    ...
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span data-feather="calendar"></span></span><span class="nav-link-text-wrapper"><span class="nav-link-text">Stocks</span></span>
                    </div>
                  </a>
                </div>
