                  ...
                  <div class="parent-wrapper label-1">
                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-report">
                      ...
                      <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                          <div class="d-flex align-items-center"><span class="nav-link-text">User Report</span>
                          </div>
                        </a>
                        <!-- more inner pages-->
                      </li>
                      <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Product Report</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Customer  Report</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="apps/crm/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Stock Report</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
