  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container">
        ...
        Choice/Opt-Out
        We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications from us after setting up an account. If you do not wish to receive promotional communications from us, then please unsubscribe by clicking on the unsubscribe link in the email or visit our Help Center at https://www.ROOPS.com/contactus/generic?query=manage-your-account&details=unsubscribe-from-promotions to unsubscribe/opt-out.
        
        Advertisement
        We use third-party advertising companies to serve ads when you visit our Platform. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this Platform and other websites in order to provide advertisements about goods and services of interest to you. You have an option to opt-out from tracking of personalized advertising using the “Opt out of Ads Personalization” settings using your device’s settings application. ROOPS will have no access to your GAID once you select this feature.
        ...
        Designation: Manager - CC - Social Media
             ...
             ROOPS Designs Pvt Ltd ,
        
        Outer Ring Road, Devarabeesanahalli Village, Varthur Hobli, Bengaluru, Karnataka : 560103, India
        
        Contact us: customergrievance@ROOPS.com
        
        Phone: 080-61561999
        
        Time: Mon - Fri(9:00 - 18:00)
        
        Customer Support: You can reach our customer support team to address any of your queries or complaints by clicking the link, selecting your order:
